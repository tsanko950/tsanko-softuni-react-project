          ...
          <div className="col-12">
            <div className="header__content">
              ...
              <ul className="header__nav">
                ...
                <li className="header__nav-item">
                  <Link className="header__nav-link" to={Path.MoviesList}>
                    Movies
                  </Link>
                </li>
              </ul>
              <div className="header__actions">
                ...
                {!isAuthenticated && (
                  <Link to={Path.Login} className="header__user">
                    <span>Sign in</span>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                {isAuthenticated && (
                  <li className="header__nav-item">
                    <Link
                      className="header__nav-link header__nav-link--more header__user"
                      to="#"
                      role="button"
                      id="dropdownMenu3"
