          ...
          <div className="col-12">
            <div className="row row--grid">
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/1.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/2.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/3.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/4.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/5.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/6.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/7.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/8.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/9.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/10.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/11.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/12.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/13.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/14.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/15.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/16.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/17.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
              ...
              <div className="col-6 col-sm-4 col-lg-3 col-xl-2">
                <div className="card">
                  <a href="details.html" className="card__cover">
                    <img src="../src/img/card/18.png" alt="" />
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
